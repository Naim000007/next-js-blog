    ...
    return (
        <div>
            <div className='flex justify-center gap-6 my-10'>
                ...
                <button className={menu === "Startup" ? 'bg-black text-white py-1 px-4 rounded-sm' : ""} onClick={() => setMenu("Startup")}>Start Up</button>

                <button className={menu === "Lifestyle" ? 'bg-black text-white py-1 px-4 rounded-sm' : ""} onClick={() => setMenu("Lifestyle")}>Life Styel</button>
            </div>
